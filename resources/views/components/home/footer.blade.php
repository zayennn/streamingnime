    ...
    <div class="footer-container">
        ...
        <div class="footer-top">
            <div class="footer-brand">
                <a href="/" class="footer-logo">StreamingNime</a>
                <p class="footer-tagline">Your Ultimate Anime Streaming Destination</p>
            ...
            <div class="footer-links">
                ...
                <div class="link-column">
                    <h3 class="link-title">Top Genres</h3>
                    <ul class="link-list">
        ...
        <div class="footer-middle">
            <div class="newsletter">
                ...
                <p class="newsletter-desc">Subscribe to our newsletter for the latest anime news and updates.</p>
            ...
            <div class="app-download">
                <h3 class="app-title">Get Our App</h3>
                <p class="app-desc">Watch anime on the go with our mobile app.</p>
        ...
        <div class="footer-bottom">
            ...
            <div class="footer-credits">
                <p>Made with ❤️ for anime fans worldwide</p>
            </div>
        </div>
    </div>
